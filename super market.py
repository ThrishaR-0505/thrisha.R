...
def send_email(to_email, subject, body):
    from_email = "emailcom"  # Replace with your email
    from_password = "password"  # Replace with your password
...
def generate_bill_details(name, email, products, total_amount):
...
def main():
    ...
    products, total_amount = get_product_details()
    bill_details = generate_bill_details(name, email, products, total_amount)
    print(bill_details)
